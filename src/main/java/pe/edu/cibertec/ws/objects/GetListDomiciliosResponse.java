...
// Generado el: 2024.11.10 a las 09:08:18 AM PET 
//
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="listdomicilios" type="{http://www.cibertec.edu.pe/ws/objects}domiciliosoap" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetListDomiciliosResponse {
    ...
    protected List<Domiciliosoap> listdomicilios;
     ...
     * 
     */
    public List<Domiciliosoap> getListdomicilios() {
        if (listdomicilios == null) {
            listdomicilios = new ArrayList<Domiciliosoap>();
        }
